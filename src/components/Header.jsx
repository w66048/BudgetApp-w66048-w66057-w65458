...
export const Header = () => {
    ...
    return (
        <div className='flex h-20 shadow-md w-full fixed top-0 left-0 bg-white items-center z-50'>
            <div className='md:px-10 py-4 px-7 flex justify-between items-center w-full'>
                <div className='flex text-2xl cursor-pointer items-center gap-2 flex-grow'>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white bg-opacity-70 backdrop-blur-sm md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${isOpen ? 'top-16 h-screen opacity-100' : 'top-[-490px] md:opacity-100 opacity-0'}`}>
                    {Links.map(link => (
